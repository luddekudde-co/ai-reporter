...
<div class="c-article-chat">
  <div class="c-article-chat__messages" #messageList>
    ...
    @if (isSending()) {
      <div class="c-article-chat__message c-article-chat__message--assistant c-article-chat__message--thinking">
        Thinking…
      </div>
    }
  </div>
    ...
    <div class="c-article-detail__hero">
      <div class="c-article-detail__hero-inner">
        <a class="c-article-detail__back" routerLink="/feed"
          >&larr; Back to Feed</a
        >
        <nav class="c-article-detail__breadcrumb">
          Feed / {{ article()!.category ?? "General" }} / Article
        </nav>
        <div class="c-article-detail__pills">
          ...
          <span class="c-article-detail__pill--impact">{{
            impactLabel()
          }}</span>
        </div>
          ...
          <div class="c-article-detail__main">
            @if (article()!.summary) {
              <div class="c-article-detail__summary-card">
                ...
                <button
                  class="c-article-detail__deep-dive"
                  (click)="toggleChat()"
                >
